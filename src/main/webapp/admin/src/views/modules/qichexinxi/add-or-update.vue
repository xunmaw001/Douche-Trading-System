  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="上市年份" prop="shangshinianfen">
              <el-input v-model="ruleForm.shangshinianfen" 
                placeholder="上市年份" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="上牌时间" prop="shangpaishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpaishijian" label="上牌时间" prop="shangpaishijian">
              <el-input v-model="ruleForm.shangpaishijian" 
                placeholder="上牌时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行驶里程" prop="xingshilicheng">
          <el-input v-model="ruleForm.xingshilicheng" 
              placeholder="行驶里程" clearable  :readonly="ro.xingshilicheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行驶里程" prop="xingshilicheng">
              <el-input v-model="ruleForm.xingshilicheng" 
                placeholder="行驶里程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                              <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qichexiangqing = this.ruleForm.qichexiangqing.replace(reg,'../../../ssm7bu05/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
